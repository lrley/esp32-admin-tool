void settingResetWiFi(){
    ...
    /* ------------------- CLIENTE -------------------- */
    wifi_staticIP = false;
    strlcpy(wifi_ssid, "LEYLAVAYEN", sizeof(wifi_ssid));
    strlcpy(wifi_passw, "09237744188", sizeof(wifi_passw));
    strlcpy(wifi_ip_static, "192.168.100.150", sizeof(wifi_ip_static));
